...
La propia aplicación DockFlare incluye una Web UI. Para proteger esta interfaz y garantizar su seguridad, DockFlare implementa una Política de seguridad de contenido (CSP) estricta en su Web UI.
...
Es importante comprender que el CSP de DockFlare se aplica **solo a la Web UI de DockFlare**.
...
El CSP de DockFlare es una parte integral de su postura de seguridad y **no es configurable por el usuario**. La política está cuidadosamente diseñada para ser lo más restrictiva posible y al mismo tiempo permitir que la Web UI funcione correctamente.
