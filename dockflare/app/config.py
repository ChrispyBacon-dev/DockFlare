...
TUNNEL_SYNC_RETRY_SECONDS = _get_int_env('TUNNEL_SYNC_RETRY_SECONDS', 60, minimum=1)
AGENT_MAX_REQUEST_BYTES = _get_int_env('AGENT_MAX_REQUEST_BYTES', 4 * 1024 * 1024, minimum=1024)
AGENT_MAX_CONTAINERS = _get_int_env('AGENT_MAX_CONTAINERS', 5000, minimum=1)
AGENT_MAX_LABELS = _get_int_env('AGENT_MAX_LABELS', 256, minimum=1)
AGENT_MAX_LABEL_KEY_BYTES = _get_int_env('AGENT_MAX_LABEL_KEY_BYTES', 256, minimum=1)
AGENT_MAX_LABEL_VALUE_BYTES = _get_int_env('AGENT_MAX_LABEL_VALUE_BYTES', 16 * 1024, minimum=1)
AGENT_MAX_CONTAINER_ID_BYTES = _get_int_env('AGENT_MAX_CONTAINER_ID_BYTES', 128, minimum=1)
AGENT_MAX_CONTAINER_NAME_BYTES = _get_int_env('AGENT_MAX_CONTAINER_NAME_BYTES', 255, minimum=1)
AGENT_MAX_EVENT_TYPE_BYTES = _get_int_env('AGENT_MAX_EVENT_TYPE_BYTES', 64, minimum=1)
...
EMAIL_CONFIG = {}
NOTIFICATION_CONFIG = {}
NOTIFICATION_QUEUE_SIZE = _get_int_env('NOTIFICATION_QUEUE_SIZE', 100, minimum=1)
NOTIFICATION_MAX_BODY_CHARS = _get_int_env('NOTIFICATION_MAX_BODY_CHARS', 4000, minimum=256)
NOTIFICATION_RESOURCE_LIST_LIMIT = _get_int_env('NOTIFICATION_RESOURCE_LIST_LIMIT', 10, minimum=1)
NOTIFICATION_HEALTH_INTERVAL_SECONDS = _get_int_env('NOTIFICATION_HEALTH_INTERVAL_SECONDS', 15, minimum=5)
